...
const TASK_STATES: Task[][] = [
  ...
  [
    ...
    { id: 3, label: "补充错误处理", status: "pending" },
...
// Step annotations
const STEP_INFO = [
  { title: "计划面板", desc: "TodoWrite 让模型把计划显式写出来，所有任务一开始都是待处理。" },
  { title: "第 1 轮：空转", desc: "模型在做事，但没有更新 todo，提醒计数开始增加。" },
  { title: "第 2 轮：继续空转", desc: "连续两轮没有推进任务，压力开始积累。" },
  { title: "提醒触发", desc: "达到阈值，系统插入提示：你还有待处理任务，请立刻认领。" },
  { title: "任务完成", desc: "模型完成当前任务后，计时器归零，说明更新 todo 会重置提醒。" },
  { title: "主动推进", desc: "模型学会这个模式后，会主动认领下一项任务。" },
  { title: "任务闭环", desc: "可见计划加提醒压力，能显著提升任务完成可靠性。" },
];
      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div className="mt-3 flex items-center justify-between rounded-md bg-zinc-100 px-3 py-2 dark:bg-zinc-800">
          <span className="font-mono text-[11px] text-zinc-500 dark:text-zinc-400">
            进度: 已完成 {doneTasks.length}/{tasks.length}
          </span>
